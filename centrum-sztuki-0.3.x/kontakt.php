...
Description: Obsługuje stronę kontaktu - aktualnie wersja statyczna z danymi wpisanymi w niej na sztywno
...
<div id="main-wrap">
	<div id="main-container" class="clearfix">
    	...
    	<section id="content-container" class="kontakt">
        	<div class="pasekKontaktLewy column-4">
            ...
            <div class="pasekKontaktSrodkowy column-4 ">
            	<h2>Ośrodek Współpracy Europejskiej ODRA</h2>
                <span>Filia nr 1</span>
                <p>ul. Młyńska 3, 55 - 200 Oława</p>
                <p>tel. 71 735 15 75</p>
                <p>fax. 71 735 19 58</p>
            ...
            <div class="pasekKontaktPrawy column-4">
            	<h2>Ośrodek Kultury<br />&nbsp;</h2>
                <span>Filia nr 2</span>
                <p>ul. 11 Listopada 27, 55 - 200 Oława</p>
				<p>tel. 71 313 28 29</p>
                <p>tel. 71 313 33 65</p>
